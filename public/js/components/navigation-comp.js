Vue.component('NavigationComp', {
    template: `
    <nav class="header__nav" v-if="!$parent.showCart" data-nav v-show="$parent.showMenu"> 
            <div class="header__nav-closed">
                <button class="nav-closed-button" data-closed aria-label="Открыть меню" @click="$parent.showMenu = false">
