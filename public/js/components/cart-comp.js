Vue.component('CartComp', {
    ...
    template: `
        <section class="cart-drop" v-show="$root.$refs.showCart.showCart">
            <div class="nav__icon-close">
                <button class="nav-closed-button" aria-label="Открыть меню" @click="$root.$refs.showCart.showCart = !$root.$refs.showCart.showCart">
...
Vue.component('cart-item', {
    ...
    <article class="cart__product">
            <div class="cart__product__img">
                <img :src="cartItem.imgURL" alt="Cart Product Image">
            </div>
